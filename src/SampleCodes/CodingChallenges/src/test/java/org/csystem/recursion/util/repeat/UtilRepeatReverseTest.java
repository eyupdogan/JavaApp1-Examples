...
public class UtilRepeatReverseTest {
    ...
    public UtilRepeatReverseTest(DataInfo dataInfo) {
    ...
    public void test()
    {
        Assert.assertEquals(dataInfo.expected, UtilRepeat.reverse(dataInfo.input));
    }
}
