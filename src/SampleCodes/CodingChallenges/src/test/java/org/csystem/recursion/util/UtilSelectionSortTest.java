...
public class UtilSelectionSortTest {
    ...
    public UtilSelectionSortTest(DataInfo dataInfo) {
    ...
    public void test()
    {
        Assert.assertArrayEquals(dataInfo.expected, Util.selectionSort(dataInfo.input));
    }
}
