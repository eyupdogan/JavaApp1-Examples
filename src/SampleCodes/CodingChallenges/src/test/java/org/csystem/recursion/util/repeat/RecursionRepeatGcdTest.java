...
public class RecursionRepeatGcdTest {
    ...
    public RecursionRepeatGcdTest(DataInfo dataInfo) {
    ...
    public void test()
    {
        Assert.assertEquals(dataInfo.expected, RecursionRepeat.gcd(dataInfo.a, dataInfo.b));
    }
}
