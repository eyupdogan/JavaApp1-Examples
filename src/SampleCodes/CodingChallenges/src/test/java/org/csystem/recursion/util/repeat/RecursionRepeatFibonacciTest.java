...
public class RecursionRepeatFibonacciTest {
    ...
    public RecursionRepeatFibonacciTest(DataInfo dataInfo) {
    ...
    public void test()
    {
        Assert.assertEquals(dataInfo.expected, RecursionRepeat.fibonacciNumber(dataInfo.n));
    }
}
